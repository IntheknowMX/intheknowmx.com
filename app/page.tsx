  ...
  return (
    <main style={{ fontFamily: "var(--font-inter, 'Inter', 'Helvetica Neue', sans-serif)", backgroundColor: '#FDF6F0', color: '#2C1810' }}>
      ...
      <section style={{
        ...
        padding: '110px 40px',
        textAlign: 'center',
        backgroundImage: 'linear-gradient(rgba(125,59,78,0.85), rgba(125,59,78,0.85)), url(/images/hero.jpg)',
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '28px' }}>
            ...
            <div style={{ backgroundColor: '#FDF6F0', padding: '40px 32px', borderRadius: '8px', borderTop: '4px solid #C4622D' }}>
              ...
              <p style={{ fontSize: '15px', lineHeight: '1.8', color: '#2C1810', marginBottom: '20px' }}>
                Navigating Mexican residency and immigration paperwork requires a trusted attorney.
                I connect Mexico newcomers with a licensed immigration specialist who handles
                temporary and permanent residency applications with care and precision.
              </p>
