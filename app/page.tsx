  ...
  return (
    <main className="page-root" style={{ fontFamily: "var(--font-inter, 'Inter', 'Helvetica Neue', sans-serif)", backgroundColor: '#FDF6F0', color: '#2C1810' }}>
      ...
      <style>{`
        ...
        .hero-gradient { position: absolute; inset: 0; z-index: 1; pointer-events: none; background: linear-gradient(to left, rgba(253,246,240,0.84) 0%, rgba(253,246,240,0.84) 8%, rgba(253,246,240,0.64) 19%, rgba(253,246,240,0.36) 30%, rgba(253,246,240,0.10) 38%, rgba(253,246,240,0) 42%), linear-gradient(to right, rgba(253,246,240,0.91) 0%, rgba(253,246,240,0.91) 28%, rgba(253,246,240,0.65) 41%, rgba(253,246,240,0.35) 51%, rgba(253,246,240,0.10) 56.5%, rgba(253,246,240,0) 58.5%); }
