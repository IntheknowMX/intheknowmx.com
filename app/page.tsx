        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '28px' }}>
            {[
              ...
              { emoji: '👩🏽', title: 'Lisa shows up. Every time.', body: "Residency appointments. Rental showings. Bureaucratic roadblocks. The technological moments that put your life on hold — SSA accounts, Mexican government portals, banking apps, online bill pay, booking travel. Whatever stands between you and your Mexico life, Lisa shows up and gets it handled. Eleven years of building a real expat life here means the right doors open — not because she knows everyone, but because everyone knows her." },
            ].map((card) => (
