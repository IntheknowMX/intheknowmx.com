        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div className="buy-cols">
            ...
            <div className="buy-col-text">
              <h2 style={{ fontSize: '32px', fontWeight: 'normal', color: '#FDF6F0', fontFamily: "var(--font-playfair, 'Playfair Display', Georgia, serif)", marginBottom: '24px' }}>Buying Differently</h2>
