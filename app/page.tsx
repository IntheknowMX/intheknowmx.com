  ...
  return (
    <main className="page-root" style={{ fontFamily: "var(--font-inter, 'Inter', 'Helvetica Neue', sans-serif)", backgroundColor: '#FDF6F0', color: '#2C1810' }}>
      ...
      <style>{`
        ...
        .hero-gradient { position: absolute; inset: 0; z-index: 1; pointer-events: none; background: linear-gradient(to left, rgba(253,246,240,0.72) 0%, rgba(253,246,240,0.54) 8%, rgba(253,246,240,0.28) 24%, rgba(253,246,240,0.08) 32%, rgba(253,246,240,0) 37%), linear-gradient(to right, rgba(253,246,240,0.72) 0%, rgba(253,246,240,0.72) 26%, rgba(253,246,240,0.55) 37%, rgba(253,246,240,0.28) 47%, rgba(253,246,240,0.08) 52%, rgba(253,246,240,0) 54%); }
